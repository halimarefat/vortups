...
rockSPE10 = SPE10_rock(56);
cti = numel(rock.perm(:,1));
for i = 1: numel(rockSPE10.perm(:,1))
    rock.perm(i,1) = rockSPE10.perm(i,1);
end
for i = 1: numel(rockSPE10.perm(:,1))
    rock.perm(numel(rockSPE10.perm(:,1))+i,1) = rockSPE10.perm(i,1);
end
for i = 1: (numel(rock.perm(:,1))-2*numel(rockSPE10.perm(:,1)))
    rock.perm(2*numel(rockSPE10.perm(:,1))+i,1) = rockSPE10.perm(i,1);
end
...
plotWell(G, W)
plotCellData(G, log10(rock.perm(:, 2)));
